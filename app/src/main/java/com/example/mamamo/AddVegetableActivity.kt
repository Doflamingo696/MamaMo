...
class AddVegetableActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveButton.setOnClickListener {
            val vegetableName = editText.text.toString()
            if (vegetableName.isEmpty()) {
                Toast.makeText(this, "Please enter vegetable name", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this, "$vegetableName added successfully!", Toast.LENGTH_SHORT).show()
            }
        }
